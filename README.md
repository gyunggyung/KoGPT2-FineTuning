...
## Fine Tuning
```
python main.py --epoch=200 --data_file_path=./dataset/All_make_lyrics_dataset.txt --save_path=./checkpoint/ --load_path=./checkpoint/auto_enter/KoGPT2_checkpoint_296000.tar --batch_size=8
```

python main.py --epoch=200 --data_file_path=./dataset/loss_test_df.csv --save_path=./checkpoint/ --load_path=./checkpoint/auto_enter/KoGPT2_checkpoint_296000.tar --batch_size=8
